...
// Model for Customer entity
    models.Customer = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/PM2-Q1/webresources/entities.customer/",
        ...
        sync: function (method, model, options) {
            ...
            if (method == 'create') {
                options.url = 'http://localhost:8080/PM2-Q1/webresources/entities.customer/';
            }
    ...
    models.CustomerCollection = Backbone.Collection.extend({
        ...
        url: "http://localhost:8080/PM2-Q1/webresources/entities.customer/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
